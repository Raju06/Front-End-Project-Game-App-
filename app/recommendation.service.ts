...
export class RecommendationService {
  ...
  getAllGames(): Observable<any> {
    return this.http.get('http://172.23.238.161:8084/api/v1/recommendation/games'+'/181');
  }
  sendGameIdToSingleplayerEngine(id,game_type,game_type_id,topic_id): Observable<any>
  {
    console.log('http://172.23.238.182:8081/api/v1/details' + '/' + game_type_id +'/'+this.userId+'/'+id);
    return this.http.get('http://172.23.238.182:8081/api/v1/details' + '/'+game_type_id+'/'+this.userId+'/'+id);
  }
  sendGameIdToMultiplayerEngine(id,game_type,game_type_id,topic_id): Observable<any>
  {
    console.log('http://172.23.238.161:8080/api/v1/details' + '/' + game_type_id +'/' + this.userId);
    return this.http.get('http://172.23.238.182:8081/api/v1/details' + '/'+game_type_id+'/'+this.userId+'/'+id);
  }
  sendGameIdToAdaptiveEngine(id,game_type,game_type_id,topic_id): Observable<any>
  {
    console.log('http://172.23.238.182:8081/api/v1/details' + '/' + game_type_id +'/' + this.userId);
    return this.http.get('http://172.23.238.182:8081/api/v1/details' + '/'+game_type_id+'/'+this.userId+'/'+id);
  }
