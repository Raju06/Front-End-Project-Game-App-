...
export class UserProfileService {
  ...
  getById(id: number): Observable<User[]> {
    return this.http.get<User[]>('http://172.23.238.166:8080/api/v1/getUser/' +id );
    // return this.http.get<User[]>('http://172.23.239.189:8080/api/v1/getUser/' +id );
  ...
  getByEmail(userEmail: string): Observable<User[]> {
    return this.http.get<User[]>('http://172.23.238.166:8080/api/v1/getUserByEmail/' +userEmail );
      // return this.http.get<User[]>('http://172.23.239.189:8080/api/v1/getUserByEmail/' +userEmail );
  }
  ...
  public updateUser(user: UserUpdate): Observable<UserUpdate> {
    ...
    // return this.http.put<UserUpdate>('http://172.23.239.189:8080/api/v1/updateUser/' + id, user);
